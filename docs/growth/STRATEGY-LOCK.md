...
| 2026-09-05 | post-lock | TRAIN×EN FB+IG (`train-en-question-consistency`; FB `1138684902641972_122131050782773778` / IG `18176745109442131`) | NO — runner async fix + AWS CLI PATH |
