...
8. **Do not collapse scoreboard lines.** Report separately by country/metro/language/mode: registered users · completed profiles · qualified profiles · Discover-eligible users · verified external paying customers · successful attributed payments. Never hide a zero-activation market inside global totals.
