...
public class SportsEventLayerService : ISportsEventLayerService
{
    ...
    private async Task SaveEventDocumentAsync(EventConfig config)
    {
        ...
        await table.PutItemAsync(new Document
        {
            ...
            ["homepageHeadline"] = config.HomepageHeadline ?? string.Empty,
            ["homepageSubheadline"] = config.HomepageSubheadline ?? string.Empty,
            ["homepageCtaPrimary"] = config.HomepageCtaPrimary ?? string.Empty,
            ["homepageCtaSecondary"] = config.HomepageCtaSecondary ?? string.Empty,
            ["homepagePromoText"] = config.HomepagePromoText ?? string.Empty,
            ["homepageBackgroundImage"] = config.HomepageBackgroundImage ?? string.Empty,
            ["homepageVisible"] = config.HomepageVisible,
            ["navbarVisible"] = config.NavbarVisible,
            ["hubRoute"] = config.HubRoute ?? string.Empty,
            ...
            ["localizedCopyJson"] = config.LocalizedCopyJson ?? string.Empty,
    ...
    private static EventConfig MapEventConfig(Document doc) => new()
    {
        ...
        HomepageHeadline = doc.ContainsKey("homepageHeadline") ? doc["homepageHeadline"].AsString() : null,
        HomepageSubheadline = doc.ContainsKey("homepageSubheadline") ? doc["homepageSubheadline"].AsString() : null,
        HomepageCtaPrimary = doc.ContainsKey("homepageCtaPrimary") ? doc["homepageCtaPrimary"].AsString() : null,
        HomepageCtaSecondary = doc.ContainsKey("homepageCtaSecondary") ? doc["homepageCtaSecondary"].AsString() : null,
        HomepagePromoText = doc.ContainsKey("homepagePromoText") ? doc["homepagePromoText"].AsString() : null,
        HomepageBackgroundImage = doc.ContainsKey("homepageBackgroundImage") ? doc["homepageBackgroundImage"].AsString() : null,
        HomepageVisible = !doc.ContainsKey("homepageVisible") || doc["homepageVisible"].AsBoolean(),
        NavbarVisible = !doc.ContainsKey("navbarVisible") || doc["navbarVisible"].AsBoolean(),
        HubRoute = doc.ContainsKey("hubRoute") ? doc["hubRoute"].AsString() : null,
        PredictionsEnabled = !doc.ContainsKey("predictionsEnabled") || doc["predictionsEnabled"].AsBoolean(),
        ExactScoreEnabled = !doc.ContainsKey("exactScoreEnabled") || doc["exactScoreEnabled"].AsBoolean(),
        WinnerPickEnabled = !doc.ContainsKey("winnerPickEnabled") || doc["winnerPickEnabled"].AsBoolean(),
        ...
        MatchIntelligenceEnabled = !doc.ContainsKey("matchIntelligenceEnabled") || doc["matchIntelligenceEnabled"].AsBoolean(),
        FanFeedEnabled = !doc.ContainsKey("fanFeedEnabled") || doc["fanFeedEnabled"].AsBoolean(),
        LocalizedCopyJson = doc.ContainsKey("localizedCopyJson") ? doc["localizedCopyJson"].AsString() : null,
