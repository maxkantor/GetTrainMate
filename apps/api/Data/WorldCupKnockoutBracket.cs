...
public static class WorldCupKnockoutBracket
{
    ...
    public static readonly IReadOnlyDictionary<string, (string Date, string Time)> KnockoutKickoffs =
        new Dictionary<string, (string, string)>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["qf-m01"] = ("2026-07-09", "20:00"), // 4:00 PM ET — France vs Morocco (Match 97)
            ["qf-m02"] = ("2026-07-10", "19:00"), // 3:00 PM ET — Spain vs Belgium (Match 98)
            ["qf-m03"] = ("2026-07-12", "01:00"), // 9:00 PM ET Jul 11 — Argentina vs Switzerland (Match 100)
            ["qf-m04"] = ("2026-07-11", "21:00"), // 5:00 PM ET — Norway vs England (Match 99)
            ["sf-m01"] = ("2026-07-14", "19:00"), // 3:00 PM ET — Semifinal (Match 101)
            ["sf-m02"] = ("2026-07-15", "19:00"), // 3:00 PM ET — Semifinal (Match 102)
            ["third-place"] = ("2026-07-18", "21:00"), // 5:00 PM ET — Third-place (Match 103)
            ["final"] = ("2026-07-19", "19:00"), // 3:00 PM ET — Final (Match 104)
        };
