...
export const pricingEn = {
  ...
  hero_title: 'Get More Matches. Instantly.',
  hero_sub: 'Use credits to unlock chats, boosts, and AI features—only when you need them.',
  hero_trust_row: '✔ No subscription   ✔ Credits never expire   ✔ Pay only when you use',
  hero_feature_pills: 'Chat · AI Icebreaker · Boost · Reveal Likes · AI Plan',
  price_per_credit: '≈ ${price} / credit',
  starter_included: 'Included free',
  best_value_popular: '🔥 Most popular choice',
  cta_get_credits: 'Get Credits',
  credit_1: '1 credit',
  credit_2: '2 credits',
  credit_3: '3 credits',
